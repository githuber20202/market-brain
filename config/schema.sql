...
ALTER TABLE liquidity_profiles ADD COLUMN IF NOT EXISTS atr14 DOUBLE PRECISION;
ALTER TABLE liquidity_profiles ADD COLUMN IF NOT EXISTS atr14_pct DOUBLE PRECISION;
ALTER TABLE liquidity_profiles ADD COLUMN IF NOT EXISTS high_52w DOUBLE PRECISION;
